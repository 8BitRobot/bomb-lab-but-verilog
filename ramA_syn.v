...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="MAX 10" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=4800 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="OLD_DATA" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=13 address_a clock0 data_a q_a wren_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.port_a_last_address = 4799,
		ram_block1a_0.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_1.port_a_last_address = 4799,
		ram_block1a_1.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_2.port_a_last_address = 4799,
		ram_block1a_2.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_3.port_a_last_address = 4799,
		ram_block1a_3.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_4.port_a_last_address = 4799,
		ram_block1a_4.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_5.port_a_last_address = 4799,
		ram_block1a_5.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_6.port_a_last_address = 4799,
		ram_block1a_6.port_a_logical_ram_depth = 4800,
	...
	defparam
		...
		ram_block1a_7.port_a_last_address = 4799,
		ram_block1a_7.port_a_logical_ram_depth = 4800,
...
`endif
	...
	ramA_altsyncram	ramA_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.wren_a (wren),
